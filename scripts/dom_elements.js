...
const toggleGatrMissileButton = document.querySelector("#toggle_gatr_missile_btn");
const addEwButton = document.querySelector("#ew_btn");
const addCartridgeButton = document.querySelector("#cartridge_btn");
const addCompletionButton = document.querySelector("#add_missile_completion_btn");
const gatrContainer = document.querySelector(".gatr-container");
const notesTextArea = document.querySelector("#notes");
const saveButton = document.querySelector("#save_messages_btn");
const loadMessagesButton = document.querySelector("#load_messages_btn");
const clearButton = document.querySelector("#clear_btn");
const clearMemoryButton = document.querySelector("#clear_memory_btn");
